...
type TableHerokuPipelineDeploymentsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableHerokuPipelineDeploymentsGenerator{}

func (x *TableHerokuPipelineDeploymentsGenerator) GetTableName() string {
	return "heroku_pipeline_deployments"
}

func (x *TableHerokuPipelineDeploymentsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableHerokuPipelineDeploymentsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableHerokuPipelineDeploymentsGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableHerokuPipelineDeploymentsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			for _, it := range items {
				...
				for nextRange.Max != 0 {
					ctxWithRange := context.WithValue(ctx, "nextRange", nextRange)
					v, err := c.PipelineDeploymentList(ctxWithRange, it.ID, nextRange)
					if err != nil {
						maybeError := errors.WithStack(err)
						return schema.NewDiagnosticsErrorPullTable(task.Table, maybeError)
					}
...
func (x *TableHerokuPipelineDeploymentsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableHerokuPipelineDeploymentsGenerator) GetColumns() []*schema.Column {
...
func (x *TableHerokuPipelineDeploymentsGenerator) GetSubTables() []*schema.Table {
	return nil
}
