...
type TableHerokuKeysGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableHerokuKeysGenerator{}

func (x *TableHerokuKeysGenerator) GetTableName() string {
	return "heroku_keys"
}

func (x *TableHerokuKeysGenerator) GetTableDescription() string {
	return ""
}

func (x *TableHerokuKeysGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableHerokuKeysGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableHerokuKeysGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			for nextRange.Max != 0 {
				...
				v, err := c.KeyList(ctxWithRange, nextRange)
				if err != nil {
...
func (x *TableHerokuKeysGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableHerokuKeysGenerator) GetColumns() []*schema.Column {
...
func (x *TableHerokuKeysGenerator) GetSubTables() []*schema.Table {
	return nil
}
