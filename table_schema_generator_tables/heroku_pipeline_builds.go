...
type TableHerokuPipelineBuildsGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableHerokuPipelineBuildsGenerator{}

func (x *TableHerokuPipelineBuildsGenerator) GetTableName() string {
	return "heroku_pipeline_builds"
}

func (x *TableHerokuPipelineBuildsGenerator) GetTableDescription() string {
	return ""
}

func (x *TableHerokuPipelineBuildsGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableHerokuPipelineBuildsGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableHerokuPipelineBuildsGenerator) GetDataSource() *schema.DataSource {
	return &schema.DataSource{
		Pull: func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask, resultChannel chan<- any) *schema.Diagnostics {
			...
			for _, it := range items {
				...
				for nextRange.Max != 0 {
					ctxWithRange := context.WithValue(ctx, "nextRange", nextRange)
					v, err := c.PipelineBuildList(ctxWithRange, it.ID, nextRange)
					if err != nil {
						maybeError := errors.WithStack(err)
						return schema.NewDiagnosticsErrorPullTable(task.Table, maybeError)
					}
...
func (x *TableHerokuPipelineBuildsGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableHerokuPipelineBuildsGenerator) GetColumns() []*schema.Column {
...
func (x *TableHerokuPipelineBuildsGenerator) GetSubTables() []*schema.Table {
	return nil
}
