...
type TableHerokuSpacesGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableHerokuSpacesGenerator{}

func (x *TableHerokuSpacesGenerator) GetTableName() string {
	return "heroku_spaces"
}

func (x *TableHerokuSpacesGenerator) GetTableDescription() string {
	return ""
}

func (x *TableHerokuSpacesGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableHerokuSpacesGenerator) GetOptions() *schema.TableOptions {
...
func (x *TableHerokuSpacesGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableHerokuSpacesGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, client any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableHerokuSpacesGenerator) GetColumns() []*schema.Column {
...
func (x *TableHerokuSpacesGenerator) GetSubTables() []*schema.Table {
	return nil
}
